...
(function($) {
	...
	$.fn.WSlot = function( options ) {
		...
		style['-webkit-'+ xform] = 'rotateY('+opts.rotation+'deg)';
		...
		if(opts.items.length) {
			...
			for (var i = 0; i < opts.items.length; i++) {
				...
				item += '<div class="wslot-item '+((i==center_index)?class_item_selected:'')+'" style="'+transform+displayed+style+'opacity:'+opacity+';">'+"<p>"+opts.items[i]+"</p>"+'</div>';
			}
